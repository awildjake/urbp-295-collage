...
Assing your image a name with the `id` attribute.

Upload your image online somewhere and paste it in the `imageUrl` attribute field.

Save. The image will appear on the map.
